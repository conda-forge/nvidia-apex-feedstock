...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/nvidia-apex-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nvidia-apex-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add nvidia-apex
# for installing globally
pixi global install nvidia-apex
```
...
It is possible to list all of the versions of `nvidia-apex` available on your platform:
...
```
pixi search nvidia-apex --channel conda-forge
```
